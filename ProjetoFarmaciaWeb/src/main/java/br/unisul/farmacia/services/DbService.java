...
public class DbService {
	...
	public void inicializaBancoDeDados() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Francisco Mello", null, TipoCliente.CLIENTE_COM_RECEITA);
		Cliente cli2 = new Cliente(null, "Gustavo Casagrande", null, TipoCliente.CLIENTE_SEM_RECEITA);
		Cliente cli3 = new Cliente(null, "Luana Silveira", null, TipoCliente.CLIENTE_SEM_RECEITA);
